...
public class LoginCtl extends BaseCtl {
 	...
 	@Override
   	...
   	protected void doGet(HttpServletRequest request,
            ...
            System.out.println("inside go get of login clt after session");   

	        String op = DataUtility.getString(request.getParameter("operation"));
            System.out.println("inside go get of login clt"+op);   

	        // get model
	        UserModelInt model =ModelFactory.getInstance().getUserModel();
	        RoleModelInt role =ModelFactory.getInstance().getRoleModel() ;
            System.out.println("inside go get of login clt after model factry object");   
	         ...
	         if (OP_LOG_OUT.equals(op)) {
	            ...
	            session.invalidate();
	             System.out.println("inside go get of login clt");   
 	 ...
 	 */
	    ...
	    log.debug(" Method doGet Started");
	    String op=DataUtility.getString(request.getParameter("operation"));
	   System.out.println("inside do post opration"+op);
	    UserModelInt model=ModelFactory.getInstance().getUserModel();
