...
protected boolean validate(HttpServletRequest request) {
	...
	pass=false;
	}else if (DataValidator.isNotNull(fname)&&!DataValidator.isFname(fname)){
	...
	if(DataValidator.isNull(lname)){
		...
		pass=false;
	}else if(DataValidator.isNotNull(lname)&&!DataValidator.isFname(lname)){
...
protected BaseDTO populateDTO(HttpServletRequest request){
	...
	dto.setLoginId(DataUtility.getString(email));
